...
def initialiseSetup():
    ...
    global settings_GRP,IK_GRP,FK_GRP,Deformers_GRP,Dynamics_GRP,sknjnts_GRP
...
def IKArmRigBuilder(prefix):
    ...
    global ikrig_grp
    control_shape_library.cube_control(prefix+"_Arm_IK_Ctrl")
    Arm_IK_ctrl=cmds.ls(prefix+"_Arm_IK_Ctrl")
    Arm_IK_ctrl_grp = cmds.group(Arm_IK_ctrl[0],n=prefix+"_Arm_IK_Ctrl_Grp")
    
    control_shape_library.pyramid_control(prefix+"_Arm_PV_Ctrl")
...
def connectArmIKFK(prefix):
    ...
    control_shape_library.spear_control(prefix+"_Arm_Settings_Ctrl")
